...
<template>
  <div class="page publish-page">
    <div class="page-header">
      <div>
        <h1>发布帖子</h1>
        <p class="subtitle">填写物品信息，发布寻物启事或失物招领</p>
      </div>
    </div>
      ...
      <div class="note-card form-card">
        <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" size="large">
          ...
          <el-form-item>
            ...
            <button class="btn-secondary cancel-btn" @click="router.push('/')">取消</button>
          </el-form-item>
        </el-form>
      </div>
    </div>
...
<style scoped>
.publish-page { max-width: 800px; padding-bottom: 36px; }
